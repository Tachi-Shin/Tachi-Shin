...
| スタイル | とにかくやってみよう・再発明志向 / ライブラリ依存を避けた理解ベースの開発 |
| 使用言語 | C / C++ / ARM64 ASM / Python / JavaScript / SQLite3 / Java(Android App) |
| エディタ | VSCode |
| 信条 | 「できないとわかっていても、できないことを確認するまではできる」|
...
| 分野 | 内容 | 状況 |
|------|------|------|
| 🧠 OS開発 (ARM64 / Raspberry Pi 4) | UART / タスクスケジューラ / コンテキストスイッチ / 割り込み  / 仮想メモリに拡張予定 | 仮想メモリ以外完成 |
| 📦 軽量Linuxライク教育OS(卒業研究) | 「ブラックボックスを透明化する教育用OS」を構想 | 計画中 |
...
![GitHub stats](https://github-readme-stats.vercel.app/api?username=Tachi-Shin&show_icons=true&theme=vue-dark&cache_seconds=21600)
